...
+
클러스터에서 ONTAP 9.10.1 이상이 실행 중이고 클라우드 스토리지에 AWS 또는 Azure를 사용하는 경우 일정 일 후에 아카이브 스토리지에 대한 백업 계층화를 활성화 또는 비활성화할 수도 있습니다.link:reference-azure-backup-tiers.html["Azure 아카이브 스토리지 사용에 대해 자세히 알아보십시오"]..
